...
<div  class="card-body">
  <h4 class="bi bi-android2 ">${eventFound.name}</h4>
  <div>
  <p class="card-text d-flex flex-wrap flex-column flex-sm-row border-top border-1 border-secondary">${eventFound.description}</p>
 <h6 class="bi bi-person-circle ">${eventFound.category}</h6>
 <h6 class="bi bi-android2">Capacity: ${eventFound.capacity}</h6>
 <h6 class="bi bi-calendar-event">${eventFound.date}</h46>
 <h6 class="bi bi-search-heart">${eventFound.place}</h6>
 <h6 class="bi bi-android2">Assistance: ${eventFound.assistance}</h6>
 <h6 class="bi bi-android2">Estimate: ${eventFound.estimate}</h6>
  </div>
  ...
  <div class="card-footer d-inline-flex justify-content-around">
                        ...
                        <h5 class="bi bi-tag-fill">Price: ${eventFound.price}$</h5>
                        </div>
