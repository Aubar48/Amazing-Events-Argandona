            ...
            <div class="col" id="event-${event._id}">
                <div class="card h-100 shadow p-3 mb-5 bg-body-tertiary rounded">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text d-flex flex-wrap flex-column flex-sm-row border-top border-1 border-secondary">${event.description}</p>
                        <h5 class ="card-category">${event.category}<h5>
                        <h5 class="bi bi-calendar-event">${event.date} </h5>
                        <h5 class="bi bi-volume-mute">Off stock</h5>
                    </div>
                    <div class="card-footer d-inline-flex justify-content-around">
                        <div class="d-flex align-items-center">
                            <h5 class="bi bi-tag-fill">Price: ${event.price}$</h5>
                        </div>
